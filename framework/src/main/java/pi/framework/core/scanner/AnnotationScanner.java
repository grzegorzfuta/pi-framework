...
public class AnnotationScanner implements ClassScanner {
    ...
    private static Logger LOGGER = Logger.getLogger(AnnotationScanner.class.getName());
    ...
    private Set<Class<?>> findClassesInPackage(String packageName) {
        ...
        try {
            ...
            LOGGER.log(SEVERE, "Error loading resource: " + path, ioException);
        }
                ...
                .forEach(file -> {
                    if (file.isDirectory()) {
                        ...
                        try {
                            ...
                            LOGGER.log(SEVERE, "Error instantiating a class: " + file.getName(), ioException);
                        }
                    }
                });
